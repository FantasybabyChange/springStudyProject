package com.fantasybaby.spring.cloud.stream.kafka.waiter.controller;

import com.fantasybaby.spring.cloud.stream.kafka.waiter.controller.request.NewOrderRequest;
import com.fantasybaby.spring.cloud.stream.kafka.waiter.controller.request.OrderStateRequest;
import com.fantasybaby.spring.cloud.stream.kafka.waiter.model.Coffee;
import com.fantasybaby.spring.cloud.stream.kafka.waiter.model.CoffeeOrder;
import com.fantasybaby.spring.cloud.stream.kafka.waiter.service.CoffeeOrderService;
import com.fantasybaby.spring.cloud.stream.kafka.waiter.service.CoffeeService;
