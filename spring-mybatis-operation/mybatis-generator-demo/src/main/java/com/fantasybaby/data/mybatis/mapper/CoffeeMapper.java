package com.fantasybaby.data.mybatis.mapper;
...
public interface CoffeeMapper {
    ...
    @Insert({
        ...
        "values (#{name,jdbcType=VARCHAR}, #{price,jdbcType=BIGINT,typeHandler=MoneyTypeHandler}, ",
    ...
    @ResultMap("CoffeeMapper.BaseResultMap")
    ...
    @Update({
        ...
        "set NAME = #{name,jdbcType=VARCHAR},",
          "PRICE = #{price,jdbcType=BIGINT,typeHandler=MoneyTypeHandler},",
